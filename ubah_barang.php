...
<div class="container-fluid px-4">
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            ...
            <form method="post" action="controller.php?ubah_barang=<?= $data['id_barang']; ?>">
                ...
                <div class="form-group mb-4">
                    ...
                    <input class="form-control <?= isset($_SESSION['errors']['tanggal_masuk']) ? 'is-invalid' : ''; ?>" name="tanggal_masuk" value="<?= $data['tanggal_masuk']; ?>" id="tanggal_masuk" type="date" />
                    <div class=" invalid-feedback">
                ...
                <div class="form-group mb-4">
                    ...
                    <input class="form-control <?= isset($_SESSION['errors']['kedaluwarsa']) ? 'is-invalid' : ''; ?>" name="kedaluwarsa" value="<?= $data['kedaluwarsa']; ?>" id="kedaluwarsa" type="date" />
                    <div class=" invalid-feedback">
